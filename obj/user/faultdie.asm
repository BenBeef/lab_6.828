...
exit(void)
{
  ...
  8000c9:	83 ec 08             	sub    $0x8,%esp
	close_all();
  8000cc:	e8 0c 0f 00 00       	call   800fdd <close_all>
	sys_env_destroy(0);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d8:	e8 83 1a 00 00       	call   801c60 <__udivdi3>
  ...
  800216:	e8 65 1b 00 00       	call   801d80 <__umoddi3>
...
00800272 <vprintfmt>:
{
  ...
  800395:	52                   	push   %edx
  800396:	68 b1 22 80 00       	push   $0x8022b1
  80039b:	53                   	push   %ebx
  80039c:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4a:	e8 a1 0f 00 00       	call   801af0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bcb:	e8 20 0f 00 00       	call   801af0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c0d:	e8 de 0e 00 00       	call   801af0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c4f:	e8 9c 0e 00 00       	call   801af0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c91:	e8 5a 0e 00 00       	call   801af0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cd3:	e8 18 0e 00 00       	call   801af0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d79:	e8 72 0d 00 00       	call   801af0 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d8b:	74 23                	je     800db0 <set_pgfault_handler+0x32>
  ...
  800d95:	a1 04 40 80 00       	mov    0x804004,%eax
  800d9a:	8b 40 48             	mov    0x48(%eax),%eax
  800d9d:	83 ec 08             	sub    $0x8,%esp
  800da0:	68 e1 0d 80 00       	push   $0x800de1
  800da5:	50                   	push   %eax
  800da6:	e8 2d ff ff ff       	call   800cd8 <sys_env_set_pgfault_upcall>
}
  ...
  800dbd:	68 00 f0 bf ee       	push   $0xeebff000
  800dc2:	50                   	push   %eax
  800dc3:	e8 c5 fd ff ff       	call   800b8d <sys_page_alloc>
  800dc8:	83 c4 10             	add    $0x10,%esp
  800dcb:	85 c0                	test   %eax,%eax
  800dcd:	79 be                	jns    800d8d <set_pgfault_handler+0xf>
            panic("sys_page_alloc: %e", r);
  800dcf:	50                   	push   %eax
  800dd0:	68 ea 21 80 00       	push   $0x8021ea
  800dd5:	6a 21                	push   $0x21
  800dd7:	68 fd 21 80 00       	push   $0x8021fd
  800ddc:	e8 0f 0d 00 00       	call   801af0 <_panic>

00800de1 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800de2:	a1 08 40 80 00       	mov    0x804008,%eax
	call *%eax
  ...
  800dec:	83 c4 08             	add    $0x8,%esp
    ...
    movl 40(%esp), %eax
  800def:	8b 44 24 28          	mov    0x28(%esp),%eax
    movl 32(%esp), %ebx
  800df3:	8b 5c 24 20          	mov    0x20(%esp),%ebx
    subl $4, %eax
  800df7:	83 e8 04             	sub    $0x4,%eax
    movl %eax, 40(%esp)
  800dfa:	89 44 24 28          	mov    %eax,0x28(%esp)
    movl %ebx, 0(%eax)
  800dfe:	89 18                	mov    %ebx,(%eax)
...
fd2num(struct Fd *fd)
{
  ...
  800e0d:	05 00 00 00 30       	add    $0x30000000,%eax
...
fd2data(struct Fd *fd)
{
  ...
  800e22:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  800e27:	2d 00 00 fe 2f       	sub    $0x2ffe0000,%eax
}
  800e2c:	5d                   	pop    %ebp
  800e2d:	c3                   	ret    
...
fd_alloc(struct Fd **fd_store)
{
  ...
  800e34:	b8 00 00 00 d0       	mov    $0xd0000000,%eax
	int i;
	struct Fd *fd;
  ...
  800e3b:	c1 ea 16             	shr    $0x16,%edx
  800e3e:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  800e45:	f6 c2 01             	test   $0x1,%dl
  800e48:	74 2a                	je     800e74 <fd_alloc+0x46>
  800e4a:	89 c2                	mov    %eax,%edx
  800e4c:	c1 ea 0c             	shr    $0xc,%edx
  800e4f:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
  800e56:	f6 c2 01             	test   $0x1,%dl
  800e59:	74 19                	je     800e74 <fd_alloc+0x46>
  800e5b:	05 00 10 00 00       	add    $0x1000,%eax
	for (i = 0; i < MAXFD; i++) {
  800e60:	3d 00 00 02 d0       	cmp    $0xd0020000,%eax
  800e65:	75 d2                	jne    800e39 <fd_alloc+0xb>
			*fd_store = fd;
			return 0;
		}
	}
	*fd_store = 0;
  800e67:	c7 01 00 00 00 00    	movl   $0x0,(%ecx)
	return -E_MAX_OPEN;
  800e6d:	b8 f6 ff ff ff       	mov    $0xfffffff6,%eax
  800e72:	eb 07                	jmp    800e7b <fd_alloc+0x4d>
			*fd_store = fd;
...
fd_lookup(int fdnum, struct Fd **fd_store)
{
  ...
  800e83:	83 f8 1f             	cmp    $0x1f,%eax
  800e86:	77 36                	ja     800ebe <fd_lookup+0x41>
		if (debug)
			cprintf("[%08x] bad fd %d\n", thisenv->env_id, fdnum);
		return -E_INVAL;
	}
	fd = INDEX2FD(fdnum);
  800e88:	c1 e0 0c             	shl    $0xc,%eax
  800e8b:	2d 00 00 00 30       	sub    $0x30000000,%eax
  ...
  800e9f:	74 24                	je     800ec5 <fd_lookup+0x48>
  ...
  800eb0:	74 1a                	je     800ecc <fd_lookup+0x4f>
		if (debug)
  ...
  800ec3:	eb f7                	jmp    800ebc <fd_lookup+0x3f>
		return -E_INVAL;
  800ec5:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  800eca:	eb f0                	jmp    800ebc <fd_lookup+0x3f>
  800ecc:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  800ed1:	eb e9                	jmp    800ebc <fd_lookup+0x3f>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800edc:	ba 88 22 80 00       	mov    $0x802288,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  800ee1:	b8 04 30 80 00       	mov    $0x803004,%eax
		if (devtab[i]->dev_id == dev_id) {
  800ee6:	39 08                	cmp    %ecx,(%eax)
  800ee8:	74 33                	je     800f1d <dev_lookup+0x4a>
  800eea:	83 c2 04             	add    $0x4,%edx
	for (i = 0; devtab[i]; i++)
  800eed:	8b 02                	mov    (%edx),%eax
  800eef:	85 c0                	test   %eax,%eax
  800ef1:	75 f3                	jne    800ee6 <dev_lookup+0x13>
			*dev = devtab[i];
			return 0;
		}
  ...
  800efe:	51                   	push   %ecx
  800eff:	50                   	push   %eax
  800f00:	68 0c 22 80 00       	push   $0x80220c
  800f05:	e8 6b f2 ff ff       	call   800175 <cprintf>
	*dev = 0;
  ...
  800f27:	eb f2                	jmp    800f1b <dev_lookup+0x48>
...
00800f29 <fd_close>:
{
  ...
  800f35:	8b 7d 0c             	mov    0xc(%ebp),%edi
	if ((r = fd_lookup(fd2num(fd), &fd2)) < 0
  800f38:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  800f3b:	50                   	push   %eax
	return ((uintptr_t) fd - FDTABLE) / PGSIZE;
  ...
  800f42:	c1 e8 0c             	shr    $0xc,%eax
	if ((r = fd_lookup(fd2num(fd), &fd2)) < 0
  800f45:	50                   	push   %eax
  800f46:	e8 32 ff ff ff       	call   800e7d <fd_lookup>
  800f4b:	89 c3                	mov    %eax,%ebx
  800f4d:	83 c4 08             	add    $0x8,%esp
  800f50:	85 c0                	test   %eax,%eax
  800f52:	78 05                	js     800f59 <fd_close+0x30>
	    || fd != fd2)
  800f54:	39 75 e4             	cmp    %esi,-0x1c(%ebp)
  800f57:	74 16                	je     800f6f <fd_close+0x46>
		return (must_exist ? r : 0);
  800f59:	89 f8                	mov    %edi,%eax
  800f5b:	84 c0                	test   %al,%al
  800f5d:	b8 00 00 00 00       	mov    $0x0,%eax
  800f62:	0f 44 d8             	cmove  %eax,%ebx
}
  ...
  800fa1:	e8 6c fc ff ff       	call   800c12 <sys_page_unmap>
	return r;
  800fa6:	83 c4 10             	add    $0x10,%esp
  800fa9:	eb ba                	jmp    800f65 <fd_close+0x3c>
			r = 0;
  800fab:	bb 00 00 00 00       	mov    $0x0,%ebx
  800fb0:	eb e9                	jmp    800f9b <fd_close+0x72>
...
close(int fdnum)
{
  ...
  800fbf:	e8 b9 fe ff ff       	call   800e7d <fd_lookup>
  ...
  800fd3:	e8 51 ff ff ff       	call   800f29 <fd_close>
...
close_all(void)
{
  ...
  800fed:	e8 c0 ff ff ff       	call   800fb2 <close>
	for (i = 0; i < MAXFD; i++)
  800ff2:	83 c3 01             	add    $0x1,%ebx
  800ff5:	83 c4 10             	add    $0x10,%esp
  800ff8:	83 fb 20             	cmp    $0x20,%ebx
  800ffb:	75 ec                	jne    800fe9 <close_all+0xc>
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  801012:	e8 66 fe ff ff       	call   800e7d <fd_lookup>
  801017:	89 c3                	mov    %eax,%ebx
  801019:	83 c4 08             	add    $0x8,%esp
  80101c:	85 c0                	test   %eax,%eax
  80101e:	0f 88 81 00 00 00    	js     8010a5 <dup+0xa3>
		return r;
	close(newfdnum);
  801024:	83 ec 0c             	sub    $0xc,%esp
  801027:	ff 75 0c             	pushl  0xc(%ebp)
  80102a:	e8 83 ff ff ff       	call   800fb2 <close>
  ...
  801041:	e8 d1 fd ff ff       	call   800e17 <fd2data>
  801046:	89 c3                	mov    %eax,%ebx
	nva = fd2data(newfd);
  801048:	89 34 24             	mov    %esi,(%esp)
  80104b:	e8 c7 fd ff ff       	call   800e17 <fd2data>
  ...
  801063:	74 11                	je     801076 <dup+0x74>
  ...
  801074:	75 39                	jne    8010af <dup+0xad>
  ...
  801094:	e8 37 fb ff ff       	call   800bd0 <sys_page_map>
  801099:	89 c3                	mov    %eax,%ebx
  80109b:	83 c4 20             	add    $0x20,%esp
  80109e:	85 c0                	test   %eax,%eax
  8010a0:	78 31                	js     8010d3 <dup+0xd1>
		goto err;
...
err:
  ...
  8010c5:	e8 06 fb ff ff       	call   800bd0 <sys_page_map>
  8010ca:	89 c3                	mov    %eax,%ebx
  8010cc:	83 c4 20             	add    $0x20,%esp
  8010cf:	85 c0                	test   %eax,%eax
  8010d1:	79 a3                	jns    801076 <dup+0x74>
	sys_page_unmap(0, newfd);
  8010d3:	83 ec 08             	sub    $0x8,%esp
  8010d6:	56                   	push   %esi
  8010d7:	6a 00                	push   $0x0
  8010d9:	e8 34 fb ff ff       	call   800c12 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8010de:	83 c4 08             	add    $0x8,%esp
  8010e1:	57                   	push   %edi
  8010e2:	6a 00                	push   $0x0
  8010e4:	e8 29 fb ff ff       	call   800c12 <sys_page_unmap>
	return r;
  8010e9:	83 c4 10             	add    $0x10,%esp
  8010ec:	eb b7                	jmp    8010a5 <dup+0xa3>
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010f5:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int r;
	struct Dev *dev;
	struct Fd *fd;

	if ((r = fd_lookup(fdnum, &fd)) < 0
  8010f8:	8d 45 f0             	lea    -0x10(%ebp),%eax
  8010fb:	50                   	push   %eax
  8010fc:	53                   	push   %ebx
  8010fd:	e8 7b fd ff ff       	call   800e7d <fd_lookup>
  801102:	83 c4 08             	add    $0x8,%esp
  801105:	85 c0                	test   %eax,%eax
  801107:	78 3f                	js     801148 <read+0x5a>
  ...
  801115:	e8 b9 fd ff ff       	call   800ed3 <dev_lookup>
  80111a:	83 c4 10             	add    $0x10,%esp
  80111d:	85 c0                	test   %eax,%eax
  80111f:	78 27                	js     801148 <read+0x5a>
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_WRONLY) {
  801121:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801124:	8b 42 08             	mov    0x8(%edx),%eax
  801127:	83 e0 03             	and    $0x3,%eax
  80112a:	83 f8 01             	cmp    $0x1,%eax
  80112d:	74 1e                	je     80114d <read+0x5f>
  ...
  801137:	74 35                	je     80116e <read+0x80>
		return -E_NOT_SUPP;
  ...
  801158:	53                   	push   %ebx
  801159:	50                   	push   %eax
  80115a:	68 4d 22 80 00       	push   $0x80224d
  80115f:	e8 11 f0 ff ff       	call   800175 <cprintf>
		return -E_INVAL;
  801164:	83 c4 10             	add    $0x10,%esp
  801167:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  80116c:	eb da                	jmp    801148 <read+0x5a>
		return -E_NOT_SUPP;
  80116e:	b8 f1 ff ff ff       	mov    $0xfffffff1,%eax
  801173:	eb d3                	jmp    801148 <read+0x5a>
...
readn(int fdnum, void *buf, size_t n)
{
  ...
  80118b:	73 25                	jae    8011b2 <readn+0x3d>
		m = read(fdnum, (char*)buf + tot, n - tot);
  80118d:	83 ec 04             	sub    $0x4,%esp
  801190:	89 f0                	mov    %esi,%eax
  801192:	29 d8                	sub    %ebx,%eax
  801194:	50                   	push   %eax
  801195:	89 d8                	mov    %ebx,%eax
  801197:	03 45 0c             	add    0xc(%ebp),%eax
  80119a:	50                   	push   %eax
  80119b:	57                   	push   %edi
  80119c:	e8 4d ff ff ff       	call   8010ee <read>
		if (m < 0)
  8011a1:	83 c4 10             	add    $0x10,%esp
  8011a4:	85 c0                	test   %eax,%eax
  8011a6:	78 08                	js     8011b0 <readn+0x3b>
			return m;
		if (m == 0)
  8011a8:	85 c0                	test   %eax,%eax
  8011aa:	74 06                	je     8011b2 <readn+0x3d>
	for (tot = 0; tot < n; tot += m) {
  8011ac:	01 c3                	add    %eax,%ebx
  8011ae:	eb d9                	jmp    801189 <readn+0x14>
		m = read(fdnum, (char*)buf + tot, n - tot);
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011c9:	50                   	push   %eax
  8011ca:	53                   	push   %ebx
  8011cb:	e8 ad fc ff ff       	call   800e7d <fd_lookup>
  8011d0:	83 c4 08             	add    $0x8,%esp
  8011d3:	85 c0                	test   %eax,%eax
  8011d5:	78 3a                	js     801211 <write+0x55>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  ...
  8011e3:	e8 eb fc ff ff       	call   800ed3 <dev_lookup>
  8011e8:	83 c4 10             	add    $0x10,%esp
  8011eb:	85 c0                	test   %eax,%eax
  8011ed:	78 22                	js     801211 <write+0x55>
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
  8011ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8011f2:	f6 40 08 03          	testb  $0x3,0x8(%eax)
  8011f6:	74 1e                	je     801216 <write+0x5a>
		return -E_INVAL;
	}
	if (debug)
  ...
  8011fb:	8b 52 0c             	mov    0xc(%edx),%edx
  8011fe:	85 d2                	test   %edx,%edx
  801200:	74 35                	je     801237 <write+0x7b>
		return -E_NOT_SUPP;
  ...
  801221:	53                   	push   %ebx
  801222:	50                   	push   %eax
  801223:	68 69 22 80 00       	push   $0x802269
  801228:	e8 48 ef ff ff       	call   800175 <cprintf>
		return -E_INVAL;
  80122d:	83 c4 10             	add    $0x10,%esp
  801230:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  801235:	eb da                	jmp    801211 <write+0x55>
		return -E_NOT_SUPP;
  801237:	b8 f1 ff ff ff       	mov    $0xfffffff1,%eax
  80123c:	eb d3                	jmp    801211 <write+0x55>
...
seek(int fdnum, off_t offset)
{
  ...
  80124b:	e8 2d fc ff ff       	call   800e7d <fd_lookup>
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801274:	50                   	push   %eax
  801275:	53                   	push   %ebx
  801276:	e8 02 fc ff ff       	call   800e7d <fd_lookup>
  80127b:	83 c4 08             	add    $0x8,%esp
  80127e:	85 c0                	test   %eax,%eax
  801280:	78 37                	js     8012b9 <ftruncate+0x52>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  ...
  80128e:	e8 40 fc ff ff       	call   800ed3 <dev_lookup>
  801293:	83 c4 10             	add    $0x10,%esp
  801296:	85 c0                	test   %eax,%eax
  801298:	78 1f                	js     8012b9 <ftruncate+0x52>
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
  80129a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80129d:	f6 40 08 03          	testb  $0x3,0x8(%eax)
  8012a1:	74 1b                	je     8012be <ftruncate+0x57>
  ...
  8012a6:	8b 52 18             	mov    0x18(%edx),%edx
  8012a9:	85 d2                	test   %edx,%edx
  8012ab:	74 32                	je     8012df <ftruncate+0x78>
		return -E_NOT_SUPP;
  ...
  8012c9:	53                   	push   %ebx
  8012ca:	50                   	push   %eax
  8012cb:	68 2c 22 80 00       	push   $0x80222c
  8012d0:	e8 a0 ee ff ff       	call   800175 <cprintf>
		return -E_INVAL;
  8012d5:	83 c4 10             	add    $0x10,%esp
  8012d8:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  8012dd:	eb da                	jmp    8012b9 <ftruncate+0x52>
		return -E_NOT_SUPP;
  8012df:	b8 f1 ff ff ff       	mov    $0xfffffff1,%eax
  8012e4:	eb d3                	jmp    8012b9 <ftruncate+0x52>
...
fstat(int fdnum, struct Stat *stat)
{
  ...
  8012f7:	e8 81 fb ff ff       	call   800e7d <fd_lookup>
  8012fc:	83 c4 08             	add    $0x8,%esp
  8012ff:	85 c0                	test   %eax,%eax
  801301:	78 4b                	js     80134e <fstat+0x68>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  ...
  80130f:	e8 bf fb ff ff       	call   800ed3 <dev_lookup>
  801314:	83 c4 10             	add    $0x10,%esp
  801317:	85 c0                	test   %eax,%eax
  801319:	78 33                	js     80134e <fstat+0x68>
		return r;
	if (!dev->dev_stat)
  80131b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80131e:	83 78 14 00          	cmpl   $0x0,0x14(%eax)
  801322:	74 2f                	je     801353 <fstat+0x6d>
		return -E_NOT_SUPP;
	stat->st_name[0] = 0;
  ...
  801358:	eb f4                	jmp    80134e <fstat+0x68>
...
stat(const char *path, struct Stat *stat)
{
  ...
  801367:	e8 e7 01 00 00       	call   801553 <open>
  80136c:	89 c3                	mov    %eax,%ebx
  80136e:	83 c4 10             	add    $0x10,%esp
  801371:	85 c0                	test   %eax,%eax
  801373:	78 1b                	js     801390 <stat+0x36>
		return fd;
	r = fstat(fd, stat);
  801375:	83 ec 08             	sub    $0x8,%esp
  801378:	ff 75 0c             	pushl  0xc(%ebp)
  80137b:	50                   	push   %eax
  80137c:	e8 65 ff ff ff       	call   8012e6 <fstat>
  801381:	89 c6                	mov    %eax,%esi
	close(fd);
  801383:	89 1c 24             	mov    %ebx,(%esp)
  801386:	e8 27 fc ff ff       	call   800fb2 <close>
	return r;
  80138b:	83 c4 10             	add    $0x10,%esp
  80138e:	89 f3                	mov    %esi,%ebx
}
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013a9:	74 27                	je     8013d2 <fsipc+0x39>
  ...
  8013ad:	68 00 50 80 00       	push   $0x805000
  8013b2:	56                   	push   %esi
  8013b3:	ff 35 00 40 80 00    	pushl  0x804000
  8013b9:	e8 d9 07 00 00       	call   801b97 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8013be:	83 c4 0c             	add    $0xc,%esp
  8013c1:	6a 00                	push   $0x0
  8013c3:	53                   	push   %ebx
  8013c4:	6a 00                	push   $0x0
  8013c6:	e8 6b 07 00 00       	call   801b36 <ipc_recv>
}
  ...
  8013d7:	e8 08 08 00 00       	call   801be4 <ipc_find_env>
  8013dc:	a3 00 40 80 00       	mov    %eax,0x804000
  8013e1:	83 c4 10             	add    $0x10,%esp
  8013e4:	eb c5                	jmp    8013ab <fsipc+0x12>

008013e6 <devfile_trunc>:
}
...
devfile_trunc(struct Fd *fd, off_t newsize)
{
  ...
  801409:	e8 8b ff ff ff       	call   801399 <fsipc>
}
  80140e:	c9                   	leave  
  80140f:	c3                   	ret    
...
00801410 <devfile_flush>:
{
  ...
  80142b:	e8 69 ff ff ff       	call   801399 <fsipc>
}
  801430:	c9                   	leave  
  801431:	c3                   	ret    

00801432 <devfile_stat>:
{
  801432:	55                   	push   %ebp
  ...
  801451:	e8 43 ff ff ff       	call   801399 <fsipc>
  801456:	85 c0                	test   %eax,%eax
  801458:	78 2c                	js     801486 <devfile_stat+0x54>
	strcpy(st->st_name, fsipcbuf.statRet.ret_name);
  80145a:	83 ec 08             	sub    $0x8,%esp
  80145d:	68 00 50 80 00       	push   $0x805000
  801462:	53                   	push   %ebx
  801463:	e8 2c f3 ff ff       	call   800794 <strcpy>
...
0080148b <devfile_write>:
{
  ...
  801494:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801499:	ba f8 0f 00 00       	mov    $0xff8,%edx
  80149e:	0f 47 c2             	cmova  %edx,%eax
    fsipcbuf.write.req_fileid = fd->fd_file.id;
  8014a1:	8b 55 08             	mov    0x8(%ebp),%edx
  8014a4:	8b 52 0c             	mov    0xc(%edx),%edx
  8014a7:	89 15 00 50 80 00    	mov    %edx,0x805000
    fsipcbuf.write.req_n = n;
  8014ad:	a3 04 50 80 00       	mov    %eax,0x805004
    memmove(fsipcbuf.write.req_buf, buf, n);
  8014b2:	50                   	push   %eax
  8014b3:	ff 75 0c             	pushl  0xc(%ebp)
  8014b6:	68 08 50 80 00       	push   $0x805008
  8014bb:	e8 62 f4 ff ff       	call   800922 <memmove>
    return fsipc(FSREQ_WRITE, NULL);
  8014c0:	ba 00 00 00 00       	mov    $0x0,%edx
  8014c5:	b8 04 00 00 00       	mov    $0x4,%eax
  8014ca:	e8 ca fe ff ff       	call   801399 <fsipc>
}
  8014cf:	c9                   	leave  
  8014d0:	c3                   	ret    

008014d1 <devfile_read>:
{
  8014d1:	55                   	push   %ebp
  ...
  8014e4:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  8014ea:	ba 00 00 00 00       	mov    $0x0,%edx
  8014ef:	b8 03 00 00 00       	mov    $0x3,%eax
  8014f4:	e8 a0 fe ff ff       	call   801399 <fsipc>
  8014f9:	89 c3                	mov    %eax,%ebx
  8014fb:	85 c0                	test   %eax,%eax
  8014fd:	78 1f                	js     80151e <devfile_read+0x4d>
	assert(r <= n);
  8014ff:	39 f0                	cmp    %esi,%eax
  801501:	77 24                	ja     801527 <devfile_read+0x56>
	assert(r <= PGSIZE);
  801503:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801508:	7f 33                	jg     80153d <devfile_read+0x6c>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  80150a:	83 ec 04             	sub    $0x4,%esp
  80150d:	50                   	push   %eax
  80150e:	68 00 50 80 00       	push   $0x805000
  801513:	ff 75 0c             	pushl  0xc(%ebp)
  801516:	e8 07 f4 ff ff       	call   800922 <memmove>
	return r;
  ...
  801526:	c3                   	ret    
	assert(r <= n);
  801527:	68 98 22 80 00       	push   $0x802298
  80152c:	68 9f 22 80 00       	push   $0x80229f
  801531:	6a 7d                	push   $0x7d
  801533:	68 b4 22 80 00       	push   $0x8022b4
  801538:	e8 b3 05 00 00       	call   801af0 <_panic>
	assert(r <= PGSIZE);
  80153d:	68 bf 22 80 00       	push   $0x8022bf
  801542:	68 9f 22 80 00       	push   $0x80229f
  801547:	6a 7e                	push   $0x7e
  801549:	68 b4 22 80 00       	push   $0x8022b4
  80154e:	e8 9d 05 00 00       	call   801af0 <_panic>
...
00801553 <open>:
{
  ...
  8015b9:	e8 49 f8 ff ff       	call   800e07 <fd2num>
  8015be:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8015c1:	8b 0d 04 40 80 00    	mov    0x804004,%ecx
  8015c7:	8b 49 48             	mov    0x48(%ecx),%ecx
  8015ca:	83 c4 08             	add    $0x8,%esp
  8015cd:	50                   	push   %eax
  8015ce:	52                   	push   %edx
  8015cf:	ff 32                	pushl  (%edx)
  8015d1:	56                   	push   %esi
  8015d2:	51                   	push   %ecx
  8015d3:	68 cc 22 80 00       	push   $0x8022cc
  8015d8:	e8 98 eb ff ff       	call   800175 <cprintf>
	return fd2num(fd);
  8015dd:	83 c4 14             	add    $0x14,%esp
  8015e0:	ff 75 f4             	pushl  -0xc(%ebp)
  8015e3:	e8 1f f8 ff ff       	call   800e07 <fd2num>
  ...
  8015fe:	e8 26 f9 ff ff       	call   800f29 <fd_close>
		return r;
  801603:	83 c4 10             	add    $0x10,%esp
  801606:	eb e5                	jmp    8015ed <open+0x9a>
		return -E_BAD_PATH;
  801608:	bb f4 ff ff ff       	mov    $0xfffffff4,%ebx
  80160d:	eb de                	jmp    8015ed <open+0x9a>
...
sync(void)
{
  ...
  80161f:	e8 75 fd ff ff       	call   801399 <fsipc>
}
  801624:	c9                   	leave  
  801625:	c3                   	ret    

00801626 <devpipe_stat>:
	return i;
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801634:	e8 de f7 ff ff       	call   800e17 <fd2data>
  801639:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  80163b:	83 c4 08             	add    $0x8,%esp
  80163e:	68 0b 23 80 00       	push   $0x80230b
  801643:	53                   	push   %ebx
  801644:	e8 4b f1 ff ff       	call   800794 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801649:	8b 46 04             	mov    0x4(%esi),%eax
  80164c:	2b 06                	sub    (%esi),%eax
  80164e:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801654:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  80165b:	00 00 00 
	stat->st_dev = &devpipe;
  80165e:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  801665:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801681:	e8 8c f5 ff ff       	call   800c12 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801686:	89 1c 24             	mov    %ebx,(%esp)
  801689:	e8 89 f7 ff ff       	call   800e17 <fd2data>
  80168e:	83 c4 08             	add    $0x8,%esp
  801691:	50                   	push   %eax
  801692:	6a 00                	push   $0x0
  801694:	e8 79 f5 ff ff       	call   800c12 <sys_page_unmap>
}
  801699:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  80169c:	c9                   	leave  
  80169d:	c3                   	ret    

0080169e <_pipeisclosed>:
{
  80169e:	55                   	push   %ebp
  ...
  8016b0:	8b 58 58             	mov    0x58(%eax),%ebx
		ret = pageref(fd) == pageref(p);
  8016b3:	83 ec 0c             	sub    $0xc,%esp
  8016b6:	57                   	push   %edi
  8016b7:	e8 61 05 00 00       	call   801c1d <pageref>
  8016bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8016bf:	89 34 24             	mov    %esi,(%esp)
  8016c2:	e8 56 05 00 00       	call   801c1d <pageref>
		nn = thisenv->env_runs;
  8016c7:	8b 15 04 40 80 00    	mov    0x804004,%edx
  8016cd:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  8016d0:	83 c4 10             	add    $0x10,%esp
  8016d3:	39 cb                	cmp    %ecx,%ebx
  8016d5:	74 1b                	je     8016f2 <_pipeisclosed+0x54>
		if (n != nn && ret == 1)
  8016d7:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  8016da:	75 cf                	jne    8016ab <_pipeisclosed+0xd>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  8016dc:	8b 42 58             	mov    0x58(%edx),%eax
  8016df:	6a 01                	push   $0x1
  8016e1:	50                   	push   %eax
  8016e2:	53                   	push   %ebx
  8016e3:	68 12 23 80 00       	push   $0x802312
  8016e8:	e8 88 ea ff ff       	call   800175 <cprintf>
  8016ed:	83 c4 10             	add    $0x10,%esp
  8016f0:	eb b9                	jmp    8016ab <_pipeisclosed+0xd>
		ret = pageref(fd) == pageref(p);
  8016f2:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  8016f5:	0f 94 c0             	sete   %al
...
00801703 <devpipe_write>:
{
  ...
  80170f:	56                   	push   %esi
  801710:	e8 02 f7 ff ff       	call   800e17 <fd2data>
  801715:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801717:	83 c4 10             	add    $0x10,%esp
  80171a:	bf 00 00 00 00       	mov    $0x0,%edi
  80171f:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801722:	74 4f                	je     801773 <devpipe_write+0x70>
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801724:	8b 43 04             	mov    0x4(%ebx),%eax
  801727:	8b 0b                	mov    (%ebx),%ecx
  801729:	8d 51 20             	lea    0x20(%ecx),%edx
  80172c:	39 d0                	cmp    %edx,%eax
  80172e:	72 14                	jb     801744 <devpipe_write+0x41>
			if (_pipeisclosed(fd, p))
  801730:	89 da                	mov    %ebx,%edx
  801732:	89 f0                	mov    %esi,%eax
  801734:	e8 65 ff ff ff       	call   80169e <_pipeisclosed>
  801739:	85 c0                	test   %eax,%eax
  80173b:	75 3a                	jne    801777 <devpipe_write+0x74>
			sys_yield();
  80173d:	e8 2c f4 ff ff       	call   800b6e <sys_yield>
  801742:	eb e0                	jmp    801724 <devpipe_write+0x21>
  ...
  801771:	eb ac                	jmp    80171f <devpipe_write+0x1c>
	return i;
  801773:	89 f8                	mov    %edi,%eax
  801775:	eb 05                	jmp    80177c <devpipe_write+0x79>
				return 0;
...
00801784 <devpipe_read>:
{
  ...
  80178d:	8b 7d 08             	mov    0x8(%ebp),%edi
	p = (struct Pipe*)fd2data(fd);
  801790:	57                   	push   %edi
  801791:	e8 81 f6 ff ff       	call   800e17 <fd2data>
  801796:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801798:	83 c4 10             	add    $0x10,%esp
  80179b:	be 00 00 00 00       	mov    $0x0,%esi
  8017a0:	3b 75 10             	cmp    0x10(%ebp),%esi
  8017a3:	74 47                	je     8017ec <devpipe_read+0x68>
		while (p->p_rpos == p->p_wpos) {
  8017a5:	8b 03                	mov    (%ebx),%eax
  8017a7:	3b 43 04             	cmp    0x4(%ebx),%eax
  8017aa:	75 22                	jne    8017ce <devpipe_read+0x4a>
			if (i > 0)
  8017ac:	85 f6                	test   %esi,%esi
  8017ae:	75 14                	jne    8017c4 <devpipe_read+0x40>
			if (_pipeisclosed(fd, p))
  8017b0:	89 da                	mov    %ebx,%edx
  8017b2:	89 f8                	mov    %edi,%eax
  8017b4:	e8 e5 fe ff ff       	call   80169e <_pipeisclosed>
  8017b9:	85 c0                	test   %eax,%eax
  8017bb:	75 33                	jne    8017f0 <devpipe_read+0x6c>
			sys_yield();
  8017bd:	e8 ac f3 ff ff       	call   800b6e <sys_yield>
  8017c2:	eb e1                	jmp    8017a5 <devpipe_read+0x21>
				return i;
  8017c4:	89 f0                	mov    %esi,%eax
}
  ...
  8017ce:	99                   	cltd   
  8017cf:	c1 ea 1b             	shr    $0x1b,%edx
  8017d2:	01 d0                	add    %edx,%eax
  8017d4:	83 e0 1f             	and    $0x1f,%eax
  8017d7:	29 d0                	sub    %edx,%eax
  8017d9:	0f b6 44 03 08       	movzbl 0x8(%ebx,%eax,1),%eax
  8017de:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8017e1:	88 04 31             	mov    %al,(%ecx,%esi,1)
		p->p_rpos++;
  8017e4:	83 03 01             	addl   $0x1,(%ebx)
	for (i = 0; i < n; i++) {
  8017e7:	83 c6 01             	add    $0x1,%esi
  8017ea:	eb b4                	jmp    8017a0 <devpipe_read+0x1c>
	return i;
  8017ec:	89 f0                	mov    %esi,%eax
  8017ee:	eb d6                	jmp    8017c6 <devpipe_read+0x42>
				return 0;
  8017f0:	b8 00 00 00 00       	mov    $0x0,%eax
  8017f5:	eb cf                	jmp    8017c6 <devpipe_read+0x42>
...
008017f7 <pipe>:
{
  ...
  80187b:	e8 97 f5 ff ff       	call   800e17 <fd2data>
  ...
  801918:	e9 4f ff ff ff       	jmp    80186c <pipe+0x75>
	sys_page_unmap(0, va);
  80191d:	83 ec 08             	sub    $0x8,%esp
  801920:	56                   	push   %esi
  801921:	6a 00                	push   $0x0
  801923:	e8 ea f2 ff ff       	call   800c12 <sys_page_unmap>
  801928:	83 c4 10             	add    $0x10,%esp
	sys_page_unmap(0, fd1);
  80192b:	83 ec 08             	sub    $0x8,%esp
  80192e:	ff 75 f0             	pushl  -0x10(%ebp)
  801931:	6a 00                	push   $0x0
  801933:	e8 da f2 ff ff       	call   800c12 <sys_page_unmap>
  801938:	83 c4 10             	add    $0x10,%esp
  80193b:	e9 1c ff ff ff       	jmp    80185c <pipe+0x65>

00801940 <pipeisclosed>:
{
  801940:	55                   	push   %ebp
  ...
  80194d:	e8 2b f5 ff ff       	call   800e7d <fd_lookup>
  801952:	83 c4 10             	add    $0x10,%esp
  801955:	85 c0                	test   %eax,%eax
  801957:	78 18                	js     801971 <pipeisclosed+0x31>
	p = (struct Pipe*) fd2data(fd);
  801959:	83 ec 0c             	sub    $0xc,%esp
  80195c:	ff 75 f4             	pushl  -0xc(%ebp)
  80195f:	e8 b3 f4 ff ff       	call   800e17 <fd2data>
	return _pipeisclosed(fd, p);
  801964:	89 c2                	mov    %eax,%edx
  801966:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801969:	e8 30 fd ff ff       	call   80169e <_pipeisclosed>
  80196e:	83 c4 10             	add    $0x10,%esp
}
  801971:	c9                   	leave  
  801972:	c3                   	ret    

00801973 <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801983:	68 2a 23 80 00       	push   $0x80232a
  801988:	ff 75 0c             	pushl  0xc(%ebp)
  80198b:	e8 04 ee ff ff       	call   800794 <strcpy>
	return 0;
}
...
00801997 <devcons_write>:
{
  ...
  80199b:	56                   	push   %esi
  80199c:	53                   	push   %ebx
  80199d:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	for (tot = 0; tot < n; tot += m) {
  8019a3:	be 00 00 00 00       	mov    $0x0,%esi
		memmove(buf, (char*)vbuf + tot, m);
  8019a8:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	for (tot = 0; tot < n; tot += m) {
  8019ae:	eb 2f                	jmp    8019df <devcons_write+0x48>
		m = n - tot;
  8019b0:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8019b3:	29 f3                	sub    %esi,%ebx
  8019b5:	83 fb 7f             	cmp    $0x7f,%ebx
  8019b8:	b8 7f 00 00 00       	mov    $0x7f,%eax
  8019bd:	0f 47 d8             	cmova  %eax,%ebx
		memmove(buf, (char*)vbuf + tot, m);
  ...
  8019c9:	50                   	push   %eax
  8019ca:	57                   	push   %edi
  8019cb:	e8 52 ef ff ff       	call   800922 <memmove>
		sys_cputs(buf, m);
  8019d0:	83 c4 08             	add    $0x8,%esp
  8019d3:	53                   	push   %ebx
  8019d4:	57                   	push   %edi
  8019d5:	e8 f7 f0 ff ff       	call   800ad1 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
  8019da:	01 de                	add    %ebx,%esi
  8019dc:	83 c4 10             	add    $0x10,%esp
  8019df:	3b 75 10             	cmp    0x10(%ebp),%esi
  8019e2:	72 cc                	jb     8019b0 <devcons_write+0x19>
}
...
008019ee <devcons_read>:
{
  ...
  8019fd:	75 07                	jne    801a06 <devcons_read+0x18>
}
  8019ff:	c9                   	leave  
  801a00:	c3                   	ret    
		sys_yield();
  801a01:	e8 68 f1 ff ff       	call   800b6e <sys_yield>
	while ((c = sys_cgetc()) == 0)
  801a06:	e8 e4 f0 ff ff       	call   800aef <sys_cgetc>
  801a0b:	85 c0                	test   %eax,%eax
  801a0d:	74 f2                	je     801a01 <devcons_read+0x13>
	if (c < 0)
  801a0f:	85 c0                	test   %eax,%eax
  801a11:	78 ec                	js     8019ff <devcons_read+0x11>
  ...
  801a22:	eb db                	jmp    8019ff <devcons_read+0x11>
		return 0;
  801a24:	b8 00 00 00 00       	mov    $0x0,%eax
  801a29:	eb d4                	jmp    8019ff <devcons_read+0x11>
...
00801a2b <cputchar>:
{
  ...
  801a3c:	50                   	push   %eax
  801a3d:	e8 8f f0 ff ff       	call   800ad1 <sys_cputs>
}
...
00801a47 <getchar>:
{
  ...
  801a55:	e8 94 f6 ff ff       	call   8010ee <read>
	if (r < 0)
  801a5a:	83 c4 10             	add    $0x10,%esp
  801a5d:	85 c0                	test   %eax,%eax
  801a5f:	78 08                	js     801a69 <getchar+0x22>
	if (r < 1)
  ...
  801a70:	eb f7                	jmp    801a69 <getchar+0x22>
...
00801a72 <iscons>:
{
  ...
  801a7f:	e8 f9 f3 ff ff       	call   800e7d <fd_lookup>
...
00801a9e <opencons>:
{
  ...
  801aa7:	50                   	push   %eax
  801aa8:	e8 81 f3 ff ff       	call   800e2e <fd_alloc>
  ...
  801ac1:	e8 c7 f0 ff ff       	call   800b8d <sys_page_alloc>
  ...
  801ae5:	50                   	push   %eax
  801ae6:	e8 1c f3 ff ff       	call   800e07 <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801af8:	8b 35 00 30 80 00    	mov    0x803000,%esi
  801afe:	e8 4c f0 ff ff       	call   800b4f <sys_getenvid>
  801b03:	83 ec 0c             	sub    $0xc,%esp
  801b06:	ff 75 0c             	pushl  0xc(%ebp)
  801b09:	ff 75 08             	pushl  0x8(%ebp)
  801b0c:	56                   	push   %esi
  801b0d:	50                   	push   %eax
  801b0e:	68 38 23 80 00       	push   $0x802338
  801b13:	e8 5d e6 ff ff       	call   800175 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801b18:	83 c4 18             	add    $0x18,%esp
  801b1b:	53                   	push   %ebx
  801b1c:	ff 75 10             	pushl  0x10(%ebp)
  801b1f:	e8 00 e6 ff ff       	call   800124 <vcprintf>
	cprintf("\n");
  801b24:	c7 04 24 23 23 80 00 	movl   $0x802323,(%esp)
  801b2b:	e8 45 e6 ff ff       	call   800175 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b46:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801b4b:	0f 44 c2             	cmove  %edx,%eax
  801b4e:	83 ec 0c             	sub    $0xc,%esp
  801b51:	50                   	push   %eax
  801b52:	e8 e6 f1 ff ff       	call   800d3d <sys_ipc_recv>
  801b57:	83 c4 10             	add    $0x10,%esp
  801b5a:	85 c0                	test   %eax,%eax
  801b5c:	78 2b                	js     801b89 <ipc_recv+0x53>
        *from_env_store = 0;
        *perm_store = 0;
        return code;
    }
  ...
  801b60:	74 0a                	je     801b6c <ipc_recv+0x36>
        *from_env_store = thisenv->env_ipc_from;
  801b62:	a1 04 40 80 00       	mov    0x804004,%eax
  801b67:	8b 40 74             	mov    0x74(%eax),%eax
  801b6a:	89 06                	mov    %eax,(%esi)
    }
    if (perm_store != NULL) {
  801b6c:	85 db                	test   %ebx,%ebx
  801b6e:	74 0a                	je     801b7a <ipc_recv+0x44>
        *perm_store = thisenv->env_ipc_perm;
  801b70:	a1 04 40 80 00       	mov    0x804004,%eax
  801b75:	8b 40 78             	mov    0x78(%eax),%eax
  ...
  801b8f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        return code;
  801b95:	eb eb                	jmp    801b82 <ipc_recv+0x4c>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ba9:	85 db                	test   %ebx,%ebx
        src_va = (void *)UTOP;
  801bab:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801bb0:	0f 44 d8             	cmove  %eax,%ebx
    }
  ...
  801bb7:	56                   	push   %esi
  801bb8:	57                   	push   %edi
  801bb9:	e8 5c f1 ff ff       	call   800d1a <sys_ipc_try_send>
  801bbe:	83 c4 10             	add    $0x10,%esp
  801bc1:	85 c0                	test   %eax,%eax
  801bc3:	74 17                	je     801bdc <ipc_send+0x45>
        if (code != -E_IPC_NOT_RECV) {
  801bc5:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bc8:	74 e9                	je     801bb3 <ipc_send+0x1c>
            panic("ipc_send error %e", code);
  801bca:	50                   	push   %eax
  801bcb:	68 5c 23 80 00       	push   $0x80235c
  801bd0:	6a 3e                	push   $0x3e
  801bd2:	68 6e 23 80 00       	push   $0x80236e
  801bd7:	e8 14 ff ff ff       	call   801af0 <_panic>
        }
    }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801bfd:	74 11                	je     801c10 <ipc_find_env+0x2c>
	for (i = 0; i < NENV; i++)
  801bff:	83 c0 01             	add    $0x1,%eax
  801c02:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c07:	75 e6                	jne    801bef <ipc_find_env+0xb>
			return envs[i].env_id;
	return 0;
  801c09:	b8 00 00 00 00       	mov    $0x0,%eax
  801c0e:	eb 0b                	jmp    801c1b <ipc_find_env+0x37>
			return envs[i].env_id;
  801c10:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c13:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
pageref(void *v)
{
  ...
  801c25:	c1 e8 16             	shr    $0x16,%eax
  801c28:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
  801c2f:	b8 00 00 00 00       	mov    $0x0,%eax
	if (!(uvpd[PDX(v)] & PTE_P))
  801c34:	f6 c1 01             	test   $0x1,%cl
  801c37:	74 1d                	je     801c56 <pageref+0x39>
	pte = uvpt[PGNUM(v)];
  801c39:	c1 ea 0c             	shr    $0xc,%edx
  801c3c:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801c43:	f6 c2 01             	test   $0x1,%dl
  801c46:	74 0e                	je     801c56 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c48:	c1 ea 0c             	shr    $0xc,%edx
  801c4b:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801c52:	ef 
  801c53:	0f b7 c0             	movzwl %ax,%eax
}
  801c56:	5d                   	pop    %ebp
  801c57:	c3                   	ret    
