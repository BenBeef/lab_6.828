...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 a4 24 80 00       	push   $0x8024a4
  80006f:	6a 09                	push   $0x9
  800071:	68 bc 24 80 00       	push   $0x8024bc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f7:	56                   	push   %esi
  8000f8:	50                   	push   %eax
  8000f9:	68 d8 24 80 00       	push   $0x8024d8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025f:	0f be 80 fb 24 80 00 	movsbl 0x8024fb(%eax),%eax
  800266:	50                   	push   %eax
...
008002b3 <vprintfmt>:
{
  ...
  8003ee:	50                   	push   %eax
  8003ef:	68 13 25 80 00       	push   $0x802513
  8003f4:	53                   	push   %ebx
  8003f5:	56                   	push   %esi
  ...
  800416:	b8 0c 25 80 00       	mov    $0x80250c,%eax
