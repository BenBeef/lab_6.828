...
umain(int argc, char **argv)
{
  ...
  8000f0:	e8 9c 16 00 00       	call   801791 <printf>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001be:	e8 56 00 00 00       	call   800219 <vcprintf>
	cprintf("\n");
  8001c3:	c7 04 24 a4 24 80 00 	movl   $0x8024a4,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cd:	e8 ce 1a 00 00       	call   801da0 <__udivdi3>
  ...
  80030b:	e8 b0 1b 00 00       	call   801ec0 <__umoddi3>
...
00800367 <vprintfmt>:
{
  ...
  80048a:	52                   	push   %edx
  80048b:	68 31 24 80 00       	push   $0x802431
  800490:	53                   	push   %ebx
  800491:	56                   	push   %esi
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f48:	ba 08 24 80 00       	mov    $0x802408,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8011c4:	53                   	push   %ebx
  8011c5:	50                   	push   %eax
  8011c6:	68 cd 23 80 00       	push   $0x8023cd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80128d:	53                   	push   %ebx
  80128e:	50                   	push   %eax
  80128f:	68 e9 23 80 00       	push   $0x8023e9
...
fsipc(unsigned type, void *dstva)
{
  ...
  801425:	e8 a8 08 00 00       	call   801cd2 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80142a:	83 c4 0c             	add    $0xc,%esp
  80142d:	6a 00                	push   $0x0
  80142f:	53                   	push   %ebx
  801430:	6a 00                	push   $0x0
  801432:	e8 3a 08 00 00       	call   801c71 <ipc_recv>
}
  ...
  801443:	e8 d7 08 00 00       	call   801d1f <ipc_find_env>
...
0080153d <devfile_read>:
{
  ...
  801592:	c3                   	ret    
	assert(r <= n);
  801593:	68 18 24 80 00       	push   $0x802418
  801598:	68 1f 24 80 00       	push   $0x80241f
  80159d:	6a 7d                	push   $0x7d
  80159f:	68 34 24 80 00       	push   $0x802434
  8015a4:	e8 e6 eb ff ff       	call   80018f <_panic>
	assert(r <= PGSIZE);
  8015a9:	68 3f 24 80 00       	push   $0x80243f
  8015ae:	68 1f 24 80 00       	push   $0x80241f
  8015b3:	6a 7e                	push   $0x7e
  8015b5:	68 34 24 80 00       	push   $0x802434
...
008015bf <open>:
{
  ...
  801625:	e8 49 f8 ff ff       	call   800e73 <fd2num>
  80162a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80162d:	8b 0d 20 60 80 00    	mov    0x806020,%ecx
  801633:	8b 49 48             	mov    0x48(%ecx),%ecx
  801636:	83 c4 08             	add    $0x8,%esp
  801639:	50                   	push   %eax
  80163a:	52                   	push   %edx
  80163b:	ff 32                	pushl  (%edx)
  80163d:	56                   	push   %esi
  80163e:	51                   	push   %ecx
  80163f:	68 4c 24 80 00       	push   $0x80244c
  801644:	e8 21 ec ff ff       	call   80026a <cprintf>
	return fd2num(fd);
  801649:	83 c4 14             	add    $0x14,%esp
  80164c:	ff 75 f4             	pushl  -0xc(%ebp)
  80164f:	e8 1f f8 ff ff       	call   800e73 <fd2num>
  ...
  80166a:	e8 26 f9 ff ff       	call   800f95 <fd_close>
		return r;
  80166f:	83 c4 10             	add    $0x10,%esp
  801672:	eb e5                	jmp    801659 <open+0x9a>
		return -E_BAD_PATH;
  801674:	bb f4 ff ff ff       	mov    $0xfffffff4,%ebx
  801679:	eb de                	jmp    801659 <open+0x9a>
...
sync(void)
{
  ...
  80168b:	e8 75 fd ff ff       	call   801405 <fsipc>
}
  801690:	c9                   	leave  
  801691:	c3                   	ret    
...
{
	if (b->error > 0) {
  801692:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
  801696:	7e 38                	jle    8016d0 <writebuf+0x3e>
{
  801698:	55                   	push   %ebp
  ...
  8016a1:	ff 70 04             	pushl  0x4(%eax)
  8016a4:	8d 40 10             	lea    0x10(%eax),%eax
  8016a7:	50                   	push   %eax
  8016a8:	ff 33                	pushl  (%ebx)
  8016aa:	e8 79 fb ff ff       	call   801228 <write>
		if (result > 0)
  8016af:	83 c4 10             	add    $0x10,%esp
  8016b2:	85 c0                	test   %eax,%eax
  8016b4:	7e 03                	jle    8016b9 <writebuf+0x27>
			b->result += result;
  8016b6:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  8016b9:	39 43 04             	cmp    %eax,0x4(%ebx)
  8016bc:	74 0d                	je     8016cb <writebuf+0x39>
			b->error = (result < 0 ? result : 0);
  8016be:	85 c0                	test   %eax,%eax
  8016c0:	ba 00 00 00 00       	mov    $0x0,%edx
  8016c5:	0f 4f c2             	cmovg  %edx,%eax
  8016c8:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
  8016cb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8016ce:	c9                   	leave  
  8016cf:	c3                   	ret    
  8016d0:	f3 c3                	repz ret 
...
putch(int ch, void *thunk)
{
  ...
  8016d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  8016dc:	8b 53 04             	mov    0x4(%ebx),%edx
  8016df:	8d 42 01             	lea    0x1(%edx),%eax
  8016e2:	89 43 04             	mov    %eax,0x4(%ebx)
  8016e5:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8016e8:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  8016ec:	3d 00 01 00 00       	cmp    $0x100,%eax
  8016f1:	74 06                	je     8016f9 <putch+0x27>
		writebuf(b);
		b->idx = 0;
	}
}
  ...
  8016fb:	e8 92 ff ff ff       	call   801692 <writebuf>
		b->idx = 0;
  801700:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
  801707:	eb ea                	jmp    8016f3 <putch+0x21>
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  80170c:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  801712:	8b 45 08             	mov    0x8(%ebp),%eax
  801715:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  80171b:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  801722:	00 00 00 
	b.result = 0;
  801725:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  80172c:	00 00 00 
	b.error = 1;
  80172f:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  801736:	00 00 00 
  ...
  801745:	50                   	push   %eax
  801746:	68 d2 16 80 00       	push   $0x8016d2
  80174b:	e8 17 ec ff ff       	call   800367 <vprintfmt>
	if (b.idx > 0)
  801750:	83 c4 10             	add    $0x10,%esp
  801753:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  80175a:	7f 11                	jg     80176d <vfprintf+0x64>
		writebuf(&b);
  ...
  80176c:	c3                   	ret    
		writebuf(&b);
  80176d:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  801773:	e8 1a ff ff ff       	call   801692 <writebuf>
  801778:	eb e2                	jmp    80175c <vfprintf+0x53>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  80177d:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  801780:	8d 45 10             	lea    0x10(%ebp),%eax
	cnt = vfprintf(fd, fmt, ap);
  801783:	50                   	push   %eax
  801784:	ff 75 0c             	pushl  0xc(%ebp)
  801787:	ff 75 08             	pushl  0x8(%ebp)
  80178a:	e8 7a ff ff ff       	call   801709 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  801794:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  801797:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vfprintf(1, fmt, ap);
  80179a:	50                   	push   %eax
  80179b:	ff 75 08             	pushl  0x8(%ebp)
  80179e:	6a 01                	push   $0x1
  8017a0:	e8 64 ff ff ff       	call   801709 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017b5:	e8 c9 f6 ff ff       	call   800e83 <fd2data>
  8017ba:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  8017bc:	83 c4 08             	add    $0x8,%esp
  8017bf:	68 8c 24 80 00       	push   $0x80248c
  8017c4:	53                   	push   %ebx
  8017c5:	e8 bf f0 ff ff       	call   800889 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  8017ca:	8b 46 04             	mov    0x4(%esi),%eax
  8017cd:	2b 06                	sub    (%esi),%eax
  8017cf:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  8017d5:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  8017dc:	00 00 00 
	stat->st_dev = &devpipe;
  8017df:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  8017e6:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801802:	e8 00 f5 ff ff       	call   800d07 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801807:	89 1c 24             	mov    %ebx,(%esp)
  80180a:	e8 74 f6 ff ff       	call   800e83 <fd2data>
  80180f:	83 c4 08             	add    $0x8,%esp
  801812:	50                   	push   %eax
  801813:	6a 00                	push   $0x0
  801815:	e8 ed f4 ff ff       	call   800d07 <sys_page_unmap>
}
  80181a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  80181d:	c9                   	leave  
  80181e:	c3                   	ret    

0080181f <_pipeisclosed>:
{
  80181f:	55                   	push   %ebp
  ...
  80182a:	89 d6                	mov    %edx,%esi
		n = thisenv->env_runs;
  80182c:	a1 20 60 80 00       	mov    0x806020,%eax
  801831:	8b 58 58             	mov    0x58(%eax),%ebx
		ret = pageref(fd) == pageref(p);
  801834:	83 ec 0c             	sub    $0xc,%esp
  801837:	57                   	push   %edi
  801838:	e8 1b 05 00 00       	call   801d58 <pageref>
  80183d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801840:	89 34 24             	mov    %esi,(%esp)
  801843:	e8 10 05 00 00       	call   801d58 <pageref>
		nn = thisenv->env_runs;
  801848:	8b 15 20 60 80 00    	mov    0x806020,%edx
  80184e:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801851:	83 c4 10             	add    $0x10,%esp
  801854:	39 cb                	cmp    %ecx,%ebx
  801856:	74 1b                	je     801873 <_pipeisclosed+0x54>
		if (n != nn && ret == 1)
  801858:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  80185b:	75 cf                	jne    80182c <_pipeisclosed+0xd>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  80185d:	8b 42 58             	mov    0x58(%edx),%eax
  801860:	6a 01                	push   $0x1
  801862:	50                   	push   %eax
  801863:	53                   	push   %ebx
  801864:	68 93 24 80 00       	push   $0x802493
  801869:	e8 fc e9 ff ff       	call   80026a <cprintf>
  80186e:	83 c4 10             	add    $0x10,%esp
  801871:	eb b9                	jmp    80182c <_pipeisclosed+0xd>
		ret = pageref(fd) == pageref(p);
  801873:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801876:	0f 94 c0             	sete   %al
...
00801884 <devpipe_write>:
{
  ...
  801890:	56                   	push   %esi
  801891:	e8 ed f5 ff ff       	call   800e83 <fd2data>
  801896:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801898:	83 c4 10             	add    $0x10,%esp
  80189b:	bf 00 00 00 00       	mov    $0x0,%edi
  8018a0:	3b 7d 10             	cmp    0x10(%ebp),%edi
  8018a3:	74 4f                	je     8018f4 <devpipe_write+0x70>
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  8018a5:	8b 43 04             	mov    0x4(%ebx),%eax
  8018a8:	8b 0b                	mov    (%ebx),%ecx
  8018aa:	8d 51 20             	lea    0x20(%ecx),%edx
  8018ad:	39 d0                	cmp    %edx,%eax
  8018af:	72 14                	jb     8018c5 <devpipe_write+0x41>
			if (_pipeisclosed(fd, p))
  8018b1:	89 da                	mov    %ebx,%edx
  8018b3:	89 f0                	mov    %esi,%eax
  8018b5:	e8 65 ff ff ff       	call   80181f <_pipeisclosed>
  8018ba:	85 c0                	test   %eax,%eax
  8018bc:	75 3a                	jne    8018f8 <devpipe_write+0x74>
			sys_yield();
  8018be:	e8 a0 f3 ff ff       	call   800c63 <sys_yield>
  8018c3:	eb e0                	jmp    8018a5 <devpipe_write+0x21>
  ...
  8018d1:	c1 fa 1f             	sar    $0x1f,%edx
  8018d4:	89 d1                	mov    %edx,%ecx
  8018d6:	c1 e9 1b             	shr    $0x1b,%ecx
  8018d9:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  8018dc:	83 e2 1f             	and    $0x1f,%edx
  8018df:	29 ca                	sub    %ecx,%edx
  8018e1:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  8018e5:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  8018e9:	83 c0 01             	add    $0x1,%eax
  8018ec:	89 43 04             	mov    %eax,0x4(%ebx)
	for (i = 0; i < n; i++) {
  8018ef:	83 c7 01             	add    $0x1,%edi
  8018f2:	eb ac                	jmp    8018a0 <devpipe_write+0x1c>
	return i;
  8018f4:	89 f8                	mov    %edi,%eax
  8018f6:	eb 05                	jmp    8018fd <devpipe_write+0x79>
				return 0;
...
00801905 <devpipe_read>:
{
  ...
  80190e:	8b 7d 08             	mov    0x8(%ebp),%edi
	p = (struct Pipe*)fd2data(fd);
  801911:	57                   	push   %edi
  801912:	e8 6c f5 ff ff       	call   800e83 <fd2data>
  801917:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801919:	83 c4 10             	add    $0x10,%esp
  80191c:	be 00 00 00 00       	mov    $0x0,%esi
  801921:	3b 75 10             	cmp    0x10(%ebp),%esi
  801924:	74 47                	je     80196d <devpipe_read+0x68>
		while (p->p_rpos == p->p_wpos) {
  801926:	8b 03                	mov    (%ebx),%eax
  801928:	3b 43 04             	cmp    0x4(%ebx),%eax
  80192b:	75 22                	jne    80194f <devpipe_read+0x4a>
			if (i > 0)
  80192d:	85 f6                	test   %esi,%esi
  80192f:	75 14                	jne    801945 <devpipe_read+0x40>
			if (_pipeisclosed(fd, p))
  801931:	89 da                	mov    %ebx,%edx
  801933:	89 f8                	mov    %edi,%eax
  801935:	e8 e5 fe ff ff       	call   80181f <_pipeisclosed>
  80193a:	85 c0                	test   %eax,%eax
  80193c:	75 33                	jne    801971 <devpipe_read+0x6c>
			sys_yield();
  80193e:	e8 20 f3 ff ff       	call   800c63 <sys_yield>
  801943:	eb e1                	jmp    801926 <devpipe_read+0x21>
				return i;
  ...
  80194f:	99                   	cltd   
  801950:	c1 ea 1b             	shr    $0x1b,%edx
  801953:	01 d0                	add    %edx,%eax
  801955:	83 e0 1f             	and    $0x1f,%eax
  801958:	29 d0                	sub    %edx,%eax
  80195a:	0f b6 44 03 08       	movzbl 0x8(%ebx,%eax,1),%eax
  80195f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801962:	88 04 31             	mov    %al,(%ecx,%esi,1)
		p->p_rpos++;
  801965:	83 03 01             	addl   $0x1,(%ebx)
	for (i = 0; i < n; i++) {
  801968:	83 c6 01             	add    $0x1,%esi
  80196b:	eb b4                	jmp    801921 <devpipe_read+0x1c>
	return i;
  80196d:	89 f0                	mov    %esi,%eax
  80196f:	eb d6                	jmp    801947 <devpipe_read+0x42>
				return 0;
  801971:	b8 00 00 00 00       	mov    $0x0,%eax
  801976:	eb cf                	jmp    801947 <devpipe_read+0x42>
...
00801978 <pipe>:
{
  ...
  8019fc:	e8 82 f4 ff ff       	call   800e83 <fd2data>
  ...
  801a0e:	e8 6f f2 ff ff       	call   800c82 <sys_page_alloc>
  801a13:	89 c3                	mov    %eax,%ebx
  801a15:	83 c4 10             	add    $0x10,%esp
  801a18:	85 c0                	test   %eax,%eax
  801a1a:	0f 88 8c 00 00 00    	js     801aac <pipe+0x134>
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  801a20:	83 ec 0c             	sub    $0xc,%esp
  801a23:	ff 75 f0             	pushl  -0x10(%ebp)
  801a26:	e8 58 f4 ff ff       	call   800e83 <fd2data>
  801a2b:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801a32:	50                   	push   %eax
  801a33:	6a 00                	push   $0x0
  801a35:	56                   	push   %esi
  801a36:	6a 00                	push   $0x0
  801a38:	e8 88 f2 ff ff       	call   800cc5 <sys_page_map>
  801a3d:	89 c3                	mov    %eax,%ebx
  801a3f:	83 c4 20             	add    $0x20,%esp
  801a42:	85 c0                	test   %eax,%eax
  801a44:	78 58                	js     801a9e <pipe+0x126>
  ...
  801a54:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  ...
  801a69:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%eax)
	pfd[0] = fd2num(fd0);
  801a70:	83 ec 0c             	sub    $0xc,%esp
  801a73:	ff 75 f4             	pushl  -0xc(%ebp)
  801a76:	e8 f8 f3 ff ff       	call   800e73 <fd2num>
  801a7b:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801a7e:	89 01                	mov    %eax,(%ecx)
	pfd[1] = fd2num(fd1);
  801a80:	83 c4 04             	add    $0x4,%esp
  801a83:	ff 75 f0             	pushl  -0x10(%ebp)
  801a86:	e8 e8 f3 ff ff       	call   800e73 <fd2num>
  801a8b:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801a8e:	89 41 04             	mov    %eax,0x4(%ecx)
	return 0;
  801a91:	83 c4 10             	add    $0x10,%esp
  801a94:	bb 00 00 00 00       	mov    $0x0,%ebx
  801a99:	e9 4f ff ff ff       	jmp    8019ed <pipe+0x75>
	sys_page_unmap(0, va);
  801a9e:	83 ec 08             	sub    $0x8,%esp
  801aa1:	56                   	push   %esi
  801aa2:	6a 00                	push   $0x0
  801aa4:	e8 5e f2 ff ff       	call   800d07 <sys_page_unmap>
  801aa9:	83 c4 10             	add    $0x10,%esp
	sys_page_unmap(0, fd1);
  801aac:	83 ec 08             	sub    $0x8,%esp
  801aaf:	ff 75 f0             	pushl  -0x10(%ebp)
  801ab2:	6a 00                	push   $0x0
  801ab4:	e8 4e f2 ff ff       	call   800d07 <sys_page_unmap>
  801ab9:	83 c4 10             	add    $0x10,%esp
  801abc:	e9 1c ff ff ff       	jmp    8019dd <pipe+0x65>

00801ac1 <pipeisclosed>:
{
  801ac1:	55                   	push   %ebp
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b04:	68 ab 24 80 00       	push   $0x8024ab
  801b09:	ff 75 0c             	pushl  0xc(%ebp)
  801b0c:	e8 78 ed ff ff       	call   800889 <strcpy>
	return 0;
}
...
00801b18 <devcons_write>:
{
  ...
  801b1c:	56                   	push   %esi
  801b1d:	53                   	push   %ebx
  801b1e:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	for (tot = 0; tot < n; tot += m) {
  801b24:	be 00 00 00 00       	mov    $0x0,%esi
		memmove(buf, (char*)vbuf + tot, m);
  801b29:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	for (tot = 0; tot < n; tot += m) {
  801b2f:	eb 2f                	jmp    801b60 <devcons_write+0x48>
		m = n - tot;
  801b31:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801b34:	29 f3                	sub    %esi,%ebx
  801b36:	83 fb 7f             	cmp    $0x7f,%ebx
  801b39:	b8 7f 00 00 00       	mov    $0x7f,%eax
  801b3e:	0f 47 d8             	cmova  %eax,%ebx
		memmove(buf, (char*)vbuf + tot, m);
  ...
  801b4a:	50                   	push   %eax
  801b4b:	57                   	push   %edi
  801b4c:	e8 c6 ee ff ff       	call   800a17 <memmove>
		sys_cputs(buf, m);
  801b51:	83 c4 08             	add    $0x8,%esp
  801b54:	53                   	push   %ebx
  801b55:	57                   	push   %edi
  801b56:	e8 6b f0 ff ff       	call   800bc6 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
  801b5b:	01 de                	add    %ebx,%esi
  801b5d:	83 c4 10             	add    $0x10,%esp
  801b60:	3b 75 10             	cmp    0x10(%ebp),%esi
  801b63:	72 cc                	jb     801b31 <devcons_write+0x19>
}
...
00801b6f <devcons_read>:
{
  ...
  801b7e:	75 07                	jne    801b87 <devcons_read+0x18>
}
  801b80:	c9                   	leave  
  801b81:	c3                   	ret    
		sys_yield();
  801b82:	e8 dc f0 ff ff       	call   800c63 <sys_yield>
	while ((c = sys_cgetc()) == 0)
  801b87:	e8 58 f0 ff ff       	call   800be4 <sys_cgetc>
  801b8c:	85 c0                	test   %eax,%eax
  801b8e:	74 f2                	je     801b82 <devcons_read+0x13>
	if (c < 0)
  801b90:	85 c0                	test   %eax,%eax
  801b92:	78 ec                	js     801b80 <devcons_read+0x11>
  ...
  801ba3:	eb db                	jmp    801b80 <devcons_read+0x11>
		return 0;
  801ba5:	b8 00 00 00 00       	mov    $0x0,%eax
  801baa:	eb d4                	jmp    801b80 <devcons_read+0x11>
...
00801bac <cputchar>:
{
  ...
  801bbd:	50                   	push   %eax
  801bbe:	e8 03 f0 ff ff       	call   800bc6 <sys_cputs>
}
...
00801bc8 <getchar>:
{
  ...
  801bd6:	e8 7f f5 ff ff       	call   80115a <read>
	if (r < 0)
  801bdb:	83 c4 10             	add    $0x10,%esp
  801bde:	85 c0                	test   %eax,%eax
  801be0:	78 08                	js     801bea <getchar+0x22>
	if (r < 1)
  ...
  801bf1:	eb f7                	jmp    801bea <getchar+0x22>
...
00801bf3 <iscons>:
{
  ...
  801c00:	e8 e4 f2 ff ff       	call   800ee9 <fd_lookup>
...
00801c1f <opencons>:
{
  ...
  801c5c:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  801c63:	83 ec 0c             	sub    $0xc,%esp
  801c66:	50                   	push   %eax
  801c67:	e8 07 f2 ff ff       	call   800e73 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c81:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801c86:	0f 44 c2             	cmove  %edx,%eax
  801c89:	83 ec 0c             	sub    $0xc,%esp
  801c8c:	50                   	push   %eax
  801c8d:	e8 a0 f1 ff ff       	call   800e32 <sys_ipc_recv>
  801c92:	83 c4 10             	add    $0x10,%esp
  801c95:	85 c0                	test   %eax,%eax
  801c97:	78 2b                	js     801cc4 <ipc_recv+0x53>
        *from_env_store = 0;
        *perm_store = 0;
        return code;
    }
  ...
  801c9b:	74 0a                	je     801ca7 <ipc_recv+0x36>
        *from_env_store = thisenv->env_ipc_from;
  801c9d:	a1 20 60 80 00       	mov    0x806020,%eax
  801ca2:	8b 40 74             	mov    0x74(%eax),%eax
  801ca5:	89 06                	mov    %eax,(%esi)
    }
    if (perm_store != NULL) {
  801ca7:	85 db                	test   %ebx,%ebx
  801ca9:	74 0a                	je     801cb5 <ipc_recv+0x44>
        *perm_store = thisenv->env_ipc_perm;
  801cab:	a1 20 60 80 00       	mov    0x806020,%eax
  801cb0:	8b 40 78             	mov    0x78(%eax),%eax
  801cb3:	89 03                	mov    %eax,(%ebx)
    }

	return (int32_t)thisenv->env_ipc_value;
  801cb5:	a1 20 60 80 00       	mov    0x806020,%eax
  801cba:	8b 40 70             	mov    0x70(%eax),%eax
}
  ...
  801cc4:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        *perm_store = 0;
  801cca:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        return code;
  801cd0:	eb eb                	jmp    801cbd <ipc_recv+0x4c>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ce4:	85 db                	test   %ebx,%ebx
        src_va = (void *)UTOP;
  801ce6:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801ceb:	0f 44 d8             	cmove  %eax,%ebx
    }
  ...
  801cf2:	56                   	push   %esi
  801cf3:	57                   	push   %edi
  801cf4:	e8 16 f1 ff ff       	call   800e0f <sys_ipc_try_send>
  801cf9:	83 c4 10             	add    $0x10,%esp
  801cfc:	85 c0                	test   %eax,%eax
  801cfe:	74 17                	je     801d17 <ipc_send+0x45>
        if (code != -E_IPC_NOT_RECV) {
  801d00:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d03:	74 e9                	je     801cee <ipc_send+0x1c>
            panic("ipc_send error %e", code);
  801d05:	50                   	push   %eax
  801d06:	68 b7 24 80 00       	push   $0x8024b7
  801d0b:	6a 3e                	push   $0x3e
  801d0d:	68 c9 24 80 00       	push   $0x8024c9
  801d12:	e8 78 e4 ff ff       	call   80018f <_panic>
        }
    }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801d2a:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801d2d:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801d33:	8b 52 50             	mov    0x50(%edx),%edx
  801d36:	39 ca                	cmp    %ecx,%edx
  801d38:	74 11                	je     801d4b <ipc_find_env+0x2c>
	for (i = 0; i < NENV; i++)
  801d3a:	83 c0 01             	add    $0x1,%eax
  801d3d:	3d 00 04 00 00       	cmp    $0x400,%eax
  801d42:	75 e6                	jne    801d2a <ipc_find_env+0xb>
			return envs[i].env_id;
	return 0;
  801d44:	b8 00 00 00 00       	mov    $0x0,%eax
  801d49:	eb 0b                	jmp    801d56 <ipc_find_env+0x37>
			return envs[i].env_id;
  801d4b:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d4e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801d53:	8b 40 48             	mov    0x48(%eax),%eax
}
  801d56:	5d                   	pop    %ebp
  801d57:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801d63:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
  801d6a:	b8 00 00 00 00       	mov    $0x0,%eax
	if (!(uvpd[PDX(v)] & PTE_P))
  801d6f:	f6 c1 01             	test   $0x1,%cl
  801d72:	74 1d                	je     801d91 <pageref+0x39>
	pte = uvpt[PGNUM(v)];
  801d74:	c1 ea 0c             	shr    $0xc,%edx
  801d77:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801d7e:	f6 c2 01             	test   $0x1,%dl
  801d81:	74 0e                	je     801d91 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d83:	c1 ea 0c             	shr    $0xc,%edx
  801d86:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801d8d:	ef 
  801d8e:	0f b7 c0             	movzwl %ax,%eax
}
  801d91:	5d                   	pop    %ebp
  801d92:	c3                   	ret    
  801d93:	66 90                	xchg   %ax,%ax
...
00801da0 <__udivdi3>:
  ...
  801dab:	8b 6c 24 30          	mov    0x30(%esp),%ebp
  801daf:	8b 74 24 34          	mov    0x34(%esp),%esi
  801db3:	8b 5c 24 38          	mov    0x38(%esp),%ebx
  801db7:	85 d2                	test   %edx,%edx
  801db9:	75 35                	jne    801df0 <__udivdi3+0x50>
  801dbb:	39 f3                	cmp    %esi,%ebx
  801dbd:	0f 87 bd 00 00 00    	ja     801e80 <__udivdi3+0xe0>
  801dc3:	85 db                	test   %ebx,%ebx
  801dc5:	89 d9                	mov    %ebx,%ecx
  801dc7:	75 0b                	jne    801dd4 <__udivdi3+0x34>
  801dc9:	b8 01 00 00 00       	mov    $0x1,%eax
  801dce:	31 d2                	xor    %edx,%edx
  801dd0:	f7 f3                	div    %ebx
  801dd2:	89 c1                	mov    %eax,%ecx
  801dd4:	31 d2                	xor    %edx,%edx
  801dd6:	89 f0                	mov    %esi,%eax
  801dd8:	f7 f1                	div    %ecx
  801dda:	89 c6                	mov    %eax,%esi
  801ddc:	89 e8                	mov    %ebp,%eax
  ...
  801df0:	39 f2                	cmp    %esi,%edx
  801df2:	77 7c                	ja     801e70 <__udivdi3+0xd0>
  801df4:	0f bd fa             	bsr    %edx,%edi
  801df7:	83 f7 1f             	xor    $0x1f,%edi
  801dfa:	0f 84 98 00 00 00    	je     801e98 <__udivdi3+0xf8>
  ...
  801e49:	72 0c                	jb     801e57 <__udivdi3+0xb7>
  801e4b:	89 f9                	mov    %edi,%ecx
  801e4d:	d3 e5                	shl    %cl,%ebp
  801e4f:	39 c5                	cmp    %eax,%ebp
  801e51:	73 5d                	jae    801eb0 <__udivdi3+0x110>
  801e53:	39 d6                	cmp    %edx,%esi
  801e55:	75 59                	jne    801eb0 <__udivdi3+0x110>
  801e57:	8d 43 ff             	lea    -0x1(%ebx),%eax
  801e5a:	31 ff                	xor    %edi,%edi
  ...
  801e64:	5d                   	pop    %ebp
  801e65:	c3                   	ret    
  801e66:	8d 76 00             	lea    0x0(%esi),%esi
  801e69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  801e82:	89 e8                	mov    %ebp,%eax
  801e84:	89 f2                	mov    %esi,%edx
  801e86:	f7 f3                	div    %ebx
  ...
  801e9a:	72 06                	jb     801ea2 <__udivdi3+0x102>
  801e9c:	31 c0                	xor    %eax,%eax
  801e9e:	39 eb                	cmp    %ebp,%ebx
  801ea0:	77 d2                	ja     801e74 <__udivdi3+0xd4>
  801ea2:	b8 01 00 00 00       	mov    $0x1,%eax
  801ea7:	eb cb                	jmp    801e74 <__udivdi3+0xd4>
  801ea9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801eb0:	89 d8                	mov    %ebx,%eax
  801eb2:	31 ff                	xor    %edi,%edi
  801eb4:	eb be                	jmp    801e74 <__udivdi3+0xd4>
...
00801ec0 <__umoddi3>:
  ...
  801ec7:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  801ecb:	8b 74 24 30          	mov    0x30(%esp),%esi
  801ecf:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  801ed3:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801ed7:	85 ed                	test   %ebp,%ebp
  801ed9:	89 f0                	mov    %esi,%eax
  801edb:	89 da                	mov    %ebx,%edx
  801edd:	75 19                	jne    801ef8 <__umoddi3+0x38>
  801edf:	39 df                	cmp    %ebx,%edi
  801ee1:	0f 86 b1 00 00 00    	jbe    801f98 <__umoddi3+0xd8>
  ...
  801ef8:	39 dd                	cmp    %ebx,%ebp
  801efa:	77 f1                	ja     801eed <__umoddi3+0x2d>
  801efc:	0f bd cd             	bsr    %ebp,%ecx
  801eff:	83 f1 1f             	xor    $0x1f,%ecx
  801f02:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801f06:	0f 84 b4 00 00 00    	je     801fc0 <__umoddi3+0x100>
  801f0c:	b8 20 00 00 00       	mov    $0x20,%eax
  801f11:	89 c2                	mov    %eax,%edx
  801f13:	8b 44 24 04          	mov    0x4(%esp),%eax
  801f17:	29 c2                	sub    %eax,%edx
  801f19:	89 c1                	mov    %eax,%ecx
  801f1b:	89 f8                	mov    %edi,%eax
  801f1d:	d3 e5                	shl    %cl,%ebp
  801f1f:	89 d1                	mov    %edx,%ecx
  801f21:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801f25:	d3 e8                	shr    %cl,%eax
  801f27:	09 c5                	or     %eax,%ebp
  801f29:	8b 44 24 04          	mov    0x4(%esp),%eax
  801f2d:	89 c1                	mov    %eax,%ecx
  801f2f:	d3 e7                	shl    %cl,%edi
  801f31:	89 d1                	mov    %edx,%ecx
  801f33:	89 7c 24 08          	mov    %edi,0x8(%esp)
  ...
  801f47:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801f4c:	09 d8                	or     %ebx,%eax
  801f4e:	f7 f5                	div    %ebp
  801f50:	d3 e6                	shl    %cl,%esi
  801f52:	89 d1                	mov    %edx,%ecx
  801f54:	f7 64 24 08          	mull   0x8(%esp)
  801f58:	39 d1                	cmp    %edx,%ecx
  801f5a:	89 c3                	mov    %eax,%ebx
  801f5c:	89 d7                	mov    %edx,%edi
  801f5e:	72 06                	jb     801f66 <__umoddi3+0xa6>
  801f60:	75 0e                	jne    801f70 <__umoddi3+0xb0>
  801f62:	39 c6                	cmp    %eax,%esi
  801f64:	73 0a                	jae    801f70 <__umoddi3+0xb0>
  801f66:	2b 44 24 08          	sub    0x8(%esp),%eax
  801f6a:	19 ea                	sbb    %ebp,%edx
  801f6c:	89 d7                	mov    %edx,%edi
  801f6e:	89 c3                	mov    %eax,%ebx
  801f70:	89 ca                	mov    %ecx,%edx
  801f72:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
  801f77:	29 de                	sub    %ebx,%esi
  801f79:	19 fa                	sbb    %edi,%edx
  801f7b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  801f7f:	89 d0                	mov    %edx,%eax
  801f81:	d3 e0                	shl    %cl,%eax
  801f83:	89 d9                	mov    %ebx,%ecx
  801f85:	d3 ee                	shr    %cl,%esi
  801f87:	d3 ea                	shr    %cl,%edx
  801f89:	09 f0                	or     %esi,%eax
  ...
  801f9c:	75 0b                	jne    801fa9 <__umoddi3+0xe9>
  ...
  801fad:	f7 f1                	div    %ecx
  801faf:	89 f0                	mov    %esi,%eax
  801fb1:	f7 f1                	div    %ecx
  801fb3:	e9 31 ff ff ff       	jmp    801ee9 <__umoddi3+0x29>
  801fb8:	90                   	nop
  801fb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801fc0:	39 dd                	cmp    %ebx,%ebp
  801fc2:	72 08                	jb     801fcc <__umoddi3+0x10c>
  801fc4:	39 f7                	cmp    %esi,%edi
  801fc6:	0f 87 21 ff ff ff    	ja     801eed <__umoddi3+0x2d>
  801fcc:	89 da                	mov    %ebx,%edx
  801fce:	89 f0                	mov    %esi,%eax
  801fd0:	29 f8                	sub    %edi,%eax
  801fd2:	19 ea                	sbb    %ebp,%edx
  801fd4:	e9 14 ff ff ff       	jmp    801eed <__umoddi3+0x2d>
