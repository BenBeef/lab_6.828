...
//
static void
region_alloc(struct Env *e, void *va, size_t len, size_t f_len,  uint32_t offset)
{
	// LAB 3: Your code here.
    ...
    uint32_t i, err, size, last;
    void *dst, *src;
    struct PageInfo *pp;
    len = ROUNDUP(len, PGSIZE);
    last = 0;
    for (i=0; i < len; ) {
        // page_alloc and memory copy
